...
public class clsHardCode  {
	public String txtPathApp= Environment.getExternalStorageDirectory()+File.separator+"Android"+File.separator+"data"+File.separator+"KNDashboard"+File.separator+"app_database"+File.separator;
	...
	//public String txtPathApp= "data"+File.separator+"data"+File.separator+"com.example.kalbespgmobile"+File.separator+"databases"+File.separator;
	public String txtPathUserData= Environment.getExternalStorageDirectory()+File.separator+"Android"+File.separator+"data"+File.separator+"KNDashboard"+File.separator+"user_data"+File.separator;
	...
	public String txtDatabaseName=txtPathApp+"KNDashboard";
	...
	public String txtTable_mBranch = "mBranch";
	public String txtTable_mBanner = "mBanner";
	public String txtTable_mRegion = "mRegion";
	public String txtTable_mTypeSumber = "mTypeSumber";
	...
	public String txtTable_tCheckinUser = "tCheckinUser";
    ...
    public String txtMethod_Kalbefood = "KALBEFOOD.LOCAL";
	...
	public String txtMessImageNotFound = "Image Not Found";
	public String txtMessProcessSuccess = "Process Successfully";
	public String txtMessSuccessDownload = "Success Download";
	public String txtMessUnableToConnect = "Unable To Connect";
	public String txtMessCheckGPS = "Please Check Your GPS";
	public String txtMessLocationUpdate = "Location Updated";
	public String txtMessnoNetworkProviderIsEnabled = "no network provider is enabled";
	public String txtMessMinChar = "please insert minimal 3 character";
	public String txtMessChar = "please insert character";
	...
	public String dtGenerateID(String Style,int sumNumber,SQLiteDatabase db){
		...
		return Style+aii+"-"+"-"+generatenum.substring(generatenum.length()-5, generatenum.length()-1);
	}
}
