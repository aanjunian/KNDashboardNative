...
import library.common.tSalesProductDetailData;
...
public class clsMainBL {
	...
	public clsStatusMenuStart checkUserActive() throws ParseException{
    	...
    	if(_tUserLoginDA.CheckLoginNow(db)){
			...
			List<tUserCheckinData> listTUserCheckin= _tUserCheckinDA.getAllDataToPushData(db);
			...
			if(listTUserCheckin != null && dvalid==false){
				dvalid=true;
			}
    		if(dvalid){
	...
	public List<tTypeOutletData> getDefaultList() {
		List<tTypeOutletData> dtList = new ArrayList<>();
		String sumberDataID = "Please Insert Keyword";
		String tipeSumberData = "";
		String namaInstitusi = "Outlet Name :";
		String namaPropinsi = "";
		String alamat = "";
		String telepon = "";
		String txtNamaKabKota = "";
		dtList.add(new tTypeOutletData(sumberDataID, tipeSumberData, namaInstitusi, namaPropinsi, alamat, telepon, txtNamaKabKota));
		return dtList;
	}
}
